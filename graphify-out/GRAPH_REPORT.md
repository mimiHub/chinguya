# Graph Report - chinguya-web  (2026-09-13)

## Corpus Check
- 204 files · ~2,562,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1564 nodes · 2896 edges · 121 communities (94 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 23 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d39346a`
...
- `AgencyRegisterScreen()` --indirect_call--> `err()`  [INFERRED]
  apps/agency/src/app/login/page.tsx → packages/mocks/src/handlers.ts
...
Cohesion: 0.10
Nodes (23): AboutTab, FEATURES, STORE_INFO, TABS, ScrollReveal(), ScrollRevealProps, SocialLoginButtons(), Banner() (+15 more)

### Community 1 - "Admin Allocation & Invoicing Data"
Cohesion: 0.08
Nodes (34): AdminAllocationsPage(), getAllocatedQty(), getTotalAllocatedQty(), mapKey(), mockAllocations, saveAllocatedQty(), addAdjustment(), AddAdjustmentInput (+26 more)
...
Cohesion: 0.06
Nodes (39): AdminDashboardPage(), AdminReservationDetailPage(), priceText(), AdminReservationsPageInner(), TABS, ADMIN_TAB_LABEL, ADMIN_TAB_ORDER, AdminReservationRow (+31 more)

### Community 6 - "App Root Layout & Bottom Nav"
Cohesion: 0.06
Nodes (31): ADMIN_MOCK_AUTH, AGENCY_MOCK_AUTH, APP_ENV, ^build, CORE_API_BASE_URL, CUSTOMER_MOCK_AUTH, dist/**, ^lint (+23 more)
...
Cohesion: 0.24
Nodes (9): CATEGORY_BADGE_VARIANT, NEWS_ITEMS, NewsItem, NOTICE_TABS, NoticeCategory, NoticePage(), Tab(), TabItem (+1 more)

### Community 9 - "Admin Agency Management"
Cohesion: 0.15
Nodes (15): api, MENU_ITEMS, TODO: 실제 연동 시 여기서 POST(신규)/PATCH(수정) 호출 후 성공하면 목록으로 이동한다., RENTAL_OPTION_LABEL, Card(), CardProps, Padding, paddingClass (+7 more)
...
Cohesion: 0.12
Nodes (13): PROVIDER_STYLE, SOCIAL_PROVIDER_ORDER, SocialLoginButtonProps, SocialProvider, Align, alignClass, Direction, directionClass (+5 more)
...
Cohesion: 0.09
Nodes (22): TODO: 실제 연동 시 "오늘"은 일본 기준(JST)으로 판정하고, useDate === 오늘인 건만 필터링한다., initialInquiries, ContactTab, QnaEntry, QnaView, initialInquiries, InquiryEntry, Badge() (+14 more)
...
Cohesion: 0.18
Nodes (13): AdminProductEditPage(), AdminProductVariant, adminProductVariants, buildVariants(), findAdminProductVariantById(), price(), RENTAL_OPTION_ORDER, variantId() (+5 more)
...
Cohesion: 0.12
Nodes (23): activeItems(), addCartItem(), bookings, CANCELLABLE_STATUSES, cancellationQuote(), cancellationScope(), cancelRequest(), cart (+15 more)
...
Cohesion: 0.16
Nodes (13): register(), worker, buildAvailability(), daysRequired(), depositAccountBase, iso(), products, S (+5 more)

### Community 35 - "Admin Settings Data"
Cohesion: 0.12
Nodes (15): assets, AdminAccount, adminAccounts, faqEntries, AdminRole, Agency, AgencyCreateResult, AgencyInvitationStatus (+7 more)
...
Cohesion: 0.14
Nodes (23): TODO: 실제 연동 시 POST /api/admin/reservations/{id}/confirm-deposit 호출로 교체, TODO: 실제 연동 시 POST /api/admin/reservations/{id}/force-cancel 호출로 교체. 재고 즉시 복원., TODO: 실제 연동 시 환불 이체 확인 후 POST /api/admin/reservations/{id}/confirm-cancel. 재고 즉시, CartPage(), formatCountdown(), lineAmount(), rentalDaysOf(), MyPage() (+15 more)

### Community 41 - "Title Component"
Cohesion: 0.13
Nodes (17): TODO: 실제 연동 시 POST /api/admin/invoices/{id}/confirm-deposit 호출로 교체, agencies, buildMonthDays(), RentalDetailPage(), toDateKey(), Calendar(), CalendarDay, Chip() (+9 more)
...
Cohesion: 0.09
Nodes (39): AgencyBookPage(), buildMonthDays(), defaultUseDate(), formatDisplayDate(), maxSelectableDateObj(), minSelectableDateObj(), parseDateInputValue(), toDateInputValue() (+31 more)
...
Cohesion: 0.09
Nodes (22): msw, openapi-typescript, dependencies, msw, devDependencies, @chinguya/typescript-config, openapi-typescript, typescript (+14 more)
...
Cohesion: 0.19
Nodes (12): BookingRow, getBookingRows(), RENTAL_OPTION_ORDER, rentalProducts, getAgencyExposedQty(), getCustomerExposedQty(), getProductStock(), heroBannerSlides (+4 more)

### Community 86 - "page.tsx"
Cohesion: 0.09
Nodes (21): depositAccount, AdjustmentRequest, AdminFaq, AdminSettings, AdminSettingsInput, AgencyAllocation, AgencyAllocationLine, AgencyInput (+13 more)
...
Cohesion: 0.10
Nodes (20): metadata, MswProvider(), SignupContent(), BottomNav(), ICON_PROPS, ICONS, ITEMS, Footer() (+12 more)

### Community 89 - "CLAUDE.md — 친구야 프론트엔드 모노레포 협업 가이드"
Cohesion: 0.08
Nodes (27): coreBaseUrl(), DELETE(), GET(), mockSession(), POST(), readTokenFromSetCookie(), metadata, AgencyLoginScreen() (+19 more)
...
Cohesion: 0.24
Nodes (7): CARD_BG, oneDayPrice(), RentalListContent(), RENTAL_OPTION_ORDER, rentalNotice, rentalProducts, Product

### Community 96 - "text.tsx"
Cohesion: 0.20
...
### Community 98 - "agencyReservationData.ts"
Cohesion: 0.12
Nodes (18): AdminAgencyDetailPage(), errorMessage(), formatDate(), invitationBadge(), AdminAgencyNewPage(), errorMessage(), AdminAgenciesPage(), errorMessage() (+10 more)
...
Cohesion: 0.09
Nodes (40): ROLE_LABEL, api, api, api, api, FormMode, ImageAttachField(), ImagePreview (+32 more)
...
### Community 102 - "authData.ts"
Cohesion: 0.36
Nodes (11): cookieOptions(), coreBaseUrl(), mockSession(), readSetCookie(), safeRedirect(), clearOAuthCookies(), GET(), GET() (+3 more)
...
Cohesion: 0.18
Nodes (10): Align, alignClass, buildClassName(), ButtonProps, CommonProps, Padding, Size, sizeClass (+2 more)
...
Cohesion: 0.33
Nodes (6): fromPriceOf(), Page(), RENTAL_CATEGORIES, STARS, HomeCarousel(), ASSET_CATEGORY_LABEL

### Community 122 - "typescript"
Cohesion: 0.13
Nodes (15): metadata, AdminLoginPage(), AdminMorePage(), BottomNav(), ICON_PROPS, ICONS, ITEMS, MENU_ITEMS (+7 more)

## Knowledge Gaps
- **716 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `type` (+711 more)
...
- **Why does `.next/**` connect `App Root Layout & Bottom Nav` to `productData.ts`, `CLAUDE.md — 친구야 프론트엔드 모노레포 협업 가이드`, `typescript`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `err()` connect `agencyReservationData.ts` to `CLAUDE.md — 친구야 프론트엔드 모노레포 협업 가이드`, `Text Component`?**
