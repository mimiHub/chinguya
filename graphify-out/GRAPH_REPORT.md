...
## Corpus Check
- 180 files · ~2,195,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1659 nodes · 2888 edges · 114 communities (89 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8bab6bef`
...
5. `Stack()` - 33 edges
6. `Card()` - 29 edges
7. `2. 관리자 페이지 (모바일)` - 23 edges
8. `친구야 — 관리자 페이지 와이어프레임 상세 설명` - 20 edges
9. `packages/types (도메인 타입/비즈니스 규칙 단일 출처)` - 18 edges
10. `Input()` - 17 edges
...
Cohesion: 0.11
Nodes (20): AdminDashboardPage(), AdminReservationDetailPage(), priceText(), AdminReservationsPage(), AdminReservationsPageInner(), ADMIN_TAB_LABEL, ADMIN_TAB_ORDER, AdminReservationRow (+12 more)

### Community 6 - "App Root Layout & Bottom Nav"
Cohesion: 0.07
Nodes (31): ^build, dist/**, ^lint, .next/**, !.next/cache/**, dependsOn, outputs, cache (+23 more)
...
Cohesion: 0.09
Nodes (22): TABS, adminReservations, AboutTab, FEATURES, STORE_INFO, TABS, CATEGORY_BADGE_VARIANT, NEWS_ITEMS (+14 more)

### Community 9 - "Admin Agency Management"
Cohesion: 0.11
Nodes (21): TODO: 실제 연동 시 POST /api/admin/invoices/{id}/confirm-deposit 호출로 교체, agencies, ContactTab, QnaEntry, QnaView, initialInquiries, Agency, CalendarDay (+13 more)

### Community 10 - "TypeScript Config Package Manifest"
Cohesion: 0.07
Nodes (36): eslint-config-prettier, @eslint/js, eslint-plugin-react, eslint-plugin-react-hooks, globals, @next/eslint-plugin-next, dependencies, eslint-config-prettier (+28 more)

### Community 11 - "Admin Accounts & Agency Onboarding"
Cohesion: 0.08
Nodes (35): LEVEL_LABEL, ROLE_LABEL, TODO: 실제 연동 시 여기서 POST /api/admin/agencies 호출로 교체한다., TODO: 실제 연동 시 여기서 세션/토큰을 저장하고, 이후 각 화면에서 로그인 여부를 확인한다., TODO: 실제 연동 시 초대 토큰과 함께 POST /api/agency/invite/complete 호출로 교체., TODO: 실제 연동 시 여기서 세션/토큰을 저장한다., Alert(), AlertProps (+27 more)

### Community 12 - "Root Workspace Manifest"
Cohesion: 0.08
Nodes (25): http-server, devDependencies, http-server, prettier, turbo, typescript, engines, node (+17 more)

### Community 13 - "API Client Package Manifest"
Cohesion: 0.06
Nodes (36): dependencies, @chinguya/types, devDependencies, @chinguya/eslint-config, @chinguya/typescript-config, typescript, exports, @chinguya/eslint-config (+28 more)

### Community 14 - "Types Package Manifest"
Cohesion: 0.06
Nodes (31): devDependencies, @chinguya/eslint-config, @chinguya/typescript-config, typescript, exports, @chinguya/eslint-config, @chinguya/typescript-config, typescript (+23 more)

### Community 15 - "Base TS Config"
Cohesion: 0.06
Nodes (33): compilerOptions, declaration, declarationMap, esModuleInterop, forceConsistentCasingInFileNames, isolatedModules, lib, module (+25 more)
...
Cohesion: 0.11
Nodes (19): TODO: 실제 연동 시 "오늘"은 일본 기준(JST)으로 판정하고, useDate === 오늘인 건만 필터링한다., TODO: 실제 연동 시 "오늘"은 일본 기준(JST)으로 판정하고, useDate === 오늘인 건만 필터링한다., TODO: 실제 연동 시 여기서 PUT /api/admin/settings 호출로 교체한다., TODO: 실제 연동 시 여기서 PUT /api/admin/settings 호출로 교체한다., initialInquiries, offSiteReturnFeeKrw, InquiryEntry, Badge() (+11 more)

### Community 18 - "Admin More Menu & Stack Layout"
Cohesion: 0.14
Nodes (12): MENU_ITEMS, RENTAL_OPTION_LABEL, Align, alignClass, Direction, directionClass, Gap, gapClass (+4 more)

### Community 19 - "Customer Next.js TS Config"
Cohesion: 0.11
Nodes (20): compilerOptions, allowJs, baseUrl, paths, exclude, extends, include, @chinguya/typescript-config/nextjs.json (+12 more)
...
Cohesion: 0.09
Nodes (22): compilerOptions, incremental, jsx, lib, noEmit, plugins, display, extends (+14 more)

### Community 24 - "Cancellation Fee & Reservation List Screens"
Cohesion: 0.06
Nodes (35): coreBaseUrl(), DELETE(), GET(), POST(), readTokenFromSetCookie(), metadata, AdminLoginPage(), AdminMorePage() (+27 more)
...
Cohesion: 0.13
Nodes (16): compilerOptions, jsx, lib, display, extends, ./base.json, DOM, DOM.Iterable (+8 more)
...
Cohesion: 0.15
Nodes (14): compilerOptions, lib, noEmit, extends, include, @chinguya/typescript-config/base.json, DOM, ES2022 (+6 more)

### Community 34 - "Text Component"
Cohesion: 0.18
Nodes (10): Size, sizeClass, TextProps, Tone, toneClass, Variant, variantClass, variantConfig (+2 more)

### Community 35 - "Admin Settings Data"
Cohesion: 0.17
Nodes (12): AdminAccount, adminAccounts, initialFaqEntries, depositAccount, faqEntries, AdminLevel, AdminRole, BOOKING_WINDOW (+4 more)
...
Cohesion: 0.18
Nodes (11): files, base.json, name, private, version, nextjs.json, react-library.json, files (+3 more)

### Community 40 - "Input Component"
Cohesion: 0.07
Nodes (35): CartPage(), formatCountdown(), lineAmount(), rentalDaysOf(), DepositContent(), MyPage(), lineAmount(), ProfilePage() (+27 more)
...
Cohesion: 0.18
Nodes (10): compilerOptions, noEmit, extends, include, @chinguya/typescript-config/base.json, src, compilerOptions, noEmit (+2 more)

### Community 45 - "UI Package TS Config"
Cohesion: 0.18
Nodes (10): compilerOptions, noEmit, extends, include, src, @chinguya/typescript-config/react-library.json, compilerOptions, noEmit (+2 more)
...
Cohesion: 0.08
Nodes (37): AgencyBookPage(), defaultUseDate(), maxSelectableDate(), minSelectableDate(), toDateInputValue(), AgencyInvoicePage(), previousPeriod(), metadata (+29 more)

### Community 76 - "2. 관리자 페이지 (모바일)"
Cohesion: 0.09
Nodes (23): 2. 관리자 페이지 (모바일), S0-A2 — 관리자 로그인, S0-A5 — 관리자 목록, S0-A6 — 관리자 등록/수정, S1-A10 — 계좌·정책 설정, S1-A1 — 대시보드, S1-A2 — 자산 관리, S1-A3 — 날짜별 재고 세팅 (+15 more)

### Community 77 - "invoiceData.ts"
Cohesion: 0.15
Nodes (18): AdminInvoiceDetailPage(), AdminInvoicesPage(), agencyReservations, now, prevDate, findInvoiceById(), getCurrentPeriod(), getInvoiceLineItems() (+10 more)
...
Cohesion: 0.10
Nodes (18): @chinguya/api-spec, 작업 규칙, 파일, baseUrl (BFF 참고), @chinguya/mocks — Slice 1 MSW 목, 구조, 앱(Next.js dev)에 붙이기, 원칙 (+10 more)
...
Cohesion: 0.12
Nodes (17): 1. 고객 페이지 (모바일), S0-C1 — 회원가입 — 소셜, S0-C2 — 회원가입 — 아이디, S0-C3 — 회원정보 수정, S1-C1 — 상품 조회, S1-C2 — 예약·캘린더, S1-C3 — 장바구니, S1-C4 — 입금 안내·확인 요청 (+9 more)

### Community 85 - "page.tsx"
Cohesion: 0.19
Nodes (10): AgencyRentalListPage(), minAgencyPrice(), BookingRow, CATEGORY_LABEL, RENTAL_OPTION_ORDER, rentalProducts, CartContext, CartContextValue (+2 more)
...
Cohesion: 0.24
Nodes (10): AdminProductEditPage(), AdminProductVariant, adminProductVariants, buildVariants(), CATEGORY_LABEL, findAdminProductVariantById(), price(), RENTAL_OPTION_ORDER (+2 more)

### Community 89 - "CLAUDE.md — 친구야 프론트엔드 모노레포 협업 가이드"
Cohesion: 0.18
Nodes (10): CLAUDE.md — 친구야 프론트엔드 모노레포 협업 가이드, graphify, 명령어, 세 사용자군 (화면 사양의 근거), 스택, 작성 규약, 작업 마무리 전 자가 점검, 저장소 구조 (+2 more)
...
Cohesion: 0.31
Nodes (8): oneDayPrice(), RentalListContent(), getAgencyExposedQty(), getCustomerExposedQty(), getProductStock(), ProductStock, productStocks, RentalCategoryKey
...
Cohesion: 0.25
Nodes (8): 3. 여행사 페이지 (데스크톱), S2-G1 — 계정 등록(초대 링크), S2-G2 — 여행사 로그인, S2-G3 — 여행사 대시보드, S2-G4 — 상품 조회, S2-G5 — 예약, S2-G6 — 여행사 예약 목록, S2-G7 — 여행사 인보이스
...
Cohesion: 0.29
Nodes (6): 0. 페이지 인덱스, 4. 핵심 도메인 규칙 요약, 고객 (모바일), 관리자 (모바일), 여행사 (데스크톱), 친구야 — 페이지 정의서 (Page Definition)
...
## Knowledge Gaps
- **747 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `type` (+742 more)
...
- **Why does `.next/**` connect `App Root Layout & Bottom Nav` to `Cancellation Fee & Reservation List Screens`, `Table Component`?**
